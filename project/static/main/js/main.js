function changeToInput(id, type, sendTo) {
    ...
    if (type == 'radio') {
        ...
        let male = `<div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="profile_gender" ${malechecked} id="inlineRadio1" value="Male">
              <label class="form-check-label" for="inlineRadio1">Male</label>
            </div>`
        let female = `
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="profile_gender" ${femalechecked} id="inlineRadio2" value="Female">
      <label class="form-check-label" for="inlineRadio2">Female</label>
    </div>`
    let other = `<div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="profile_gender" ${otherchecked} id="inlineRadio3" value="Other">
      <label class="form-check-label" for="inlineRadio3">Other</label>
    </div>
    `;
        elm.innerHTML = `<div onchange="SendValue('${id}','profile_gender','${sendTo}')">${male+female+other}</div>`;
    }
    else{
...
function SendValue(id,value,to) {
    console.log(value);
    if (id == 'profile_gender')
        value = radioValue('profile_gender');
	$.ajax(
    {
        type:"GET",
        url: to,
