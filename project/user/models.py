...
class Profile(models.Model):
	profile_gen = (('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other'))
	user = models.OneToOneField(User, on_delete = models.CASCADE)
	profile_about_me = models.CharField(max_length=250, null=True,default='About Me')
	profile_birthday = models.DateField(null=True)
	profile_pic = models.ImageField(upload_to = upload_profile_to, null=True, default = 'defaults/profile_pic.jpg')
	profile_cover_image = models.ImageField(upload_to = upload_cover_to, null = True, default= 'defaults/cover_image.jpg')
	profile_gender = models.CharField(choices=profile_gen, max_length=6, null=True)
	...
	def save(self, *args, **kwargs):
		...
		img2 = Image.open(self.profile_cover_image.path)
		if img2.height > 500 or img2.width > 500:
			output_size = (500, 500)
			img2.thumbnail(output_size)
			img2.save(self.profile_cover_image.path)
